...
import com.example.exam_web.model.binding.UserLoginBindingModel;
import com.example.exam_web.model.binding.UserRegisterBindingModel;
...
public class UserController {
    ...
    public String confirmRegister(@Valid UserRegisterBindingModel userRegisterBindingModel, BindingResult bindingResult, RedirectAttributes redirectAttributes){
        boolean usernameFree = userService.freeUsername(userRegisterBindingModel.getUsername());
        boolean confirmPassword = userRegisterBindingModel.getPassword().equals(userRegisterBindingModel.getConfirmPassword());

        if (bindingResult.hasErrors() || !usernameFree || !confirmPassword){
    ...
    public String confirmLogin(@Valid UserLoginBindingModel userLoginBindingModel,BindingResult bindingResult,RedirectAttributes redirectAttributes){
       ...
       // boolean usernameNotFree = !userService.freeUsername(userLoginBindingModel.getUsername());
